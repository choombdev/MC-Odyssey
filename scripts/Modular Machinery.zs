...
recipes.addShaped(<modularmachinery:blockenergyinputhatch:4>, [[<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>],[<mekanism:enrichedalloy>, <modularmachinery:blockenergyinputhatch:3>, <mekanism:enrichedalloy>], [<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>]]);
...
recipes.addShaped(<modularmachinery:blockinputbus:4>, [[<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>],[<mekanism:enrichedalloy>, <modularmachinery:blockinputbus:3>, <mekanism:enrichedalloy>], [<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>]]);
...
recipes.addShaped(<modularmachinery:blockoutputbus:4>, [[<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>],[<mekanism:enrichedalloy>, <modularmachinery:blockoutputbus:3>, <mekanism:enrichedalloy>], [<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>]]);
...
recipes.addShaped(<modularmachinery:blockfluidoutputhatch:4>, [[<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>],[<mekanism:enrichedalloy>, <modularmachinery:blockfluidoutputhatch:3>, <mekanism:enrichedalloy>], [<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>]]);
...
recipes.addShaped(<modularmachinery:blockfluidinputhatch:4>, [[<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>],[<mekanism:enrichedalloy>, <modularmachinery:blockfluidinputhatch:3>, <mekanism:enrichedalloy>], [<jaopca:item_plateosmium>, <mekanism:controlcircuit>, <jaopca:item_plateosmium>]]);
